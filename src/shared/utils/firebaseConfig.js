...
const getEnv = (nextKey, expoKey) => process.env[nextKey] || process.env[expoKey] || ''
...
export const firebaseConfig = {
  ...
  databaseURL: getEnv('NEXT_PUBLIC_FIREBASE_DATABASE_URL', 'EXPO_PUBLIC_FIREBASE_DATABASE_URL')
}
