...
export default function FormationOverlayControl({ theme = 'dark', roomId = 'default' }) {
  ...
  const [selectedTeam, setSelectedTeam] = useState(() => {
    ...
    if (typeof window !== 'undefined') {
      ...
      return localStorage.getItem('lastFormationTeam') || 'Belanda'
  ...
  const [selectedFormation, setSelectedFormation] = useState(() => {
    ...
    if (typeof window !== 'undefined') {
      ...
      return localStorage.getItem('lastFormationId') || '4-3-3'
  ...
  // Track Firebase state to know if what's onscreen matches local

  const [remoteState, setRemoteState] = useState(null)

  const [hostUrl, setHostUrl] = useState('')

  // Initialize data on team or formation change

  useEffect(() => {

    const loadTeamData = async () => {

      let team = playerData.find(t => t.negara === selectedTeam);

      if (!team) team = playerData[0];

      try {

        const snapshot = await import('firebase/database').then(m => m.get(ref(db, `match_live/global_formation_presets/${selectedTeam}`)));
        ...
        if (snapshot.exists()) {
          ...
          if (data.formation) {
            ...
            localStorage.setItem('lastFormationId', data.formation);
      ...
      localStorage.setItem('lastFormationId', defaultForm);
  ...
  const handleSavePreset = () => {
    ...
    }).then(() => alert('Formation Saved Globally!'))
  ...
  const handleTeamChange = (e) => {
    ...
    setSelectedFormation(formationMap[newTeam] || '4-3-3');
  ...
  const handleDrop = (e, targetPlayerId, targetType) => {
    ...
    // Handle Unassign (dragging from pitch to substitutes list)
    ...
    if (draggedType === 'player' && targetType === 'player') {
      ...
      if (playerObj.isEmpty) return; // Cannot drag empty slot to sub
...
`}} />
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <h2 className="text-xl font-bold">Formation Control Panel</h2>
          ...
          <FormControl size="small" className="min-w-[150px]">
            ...
            <Select
              ...
              onChange={(e) => {
                ...
                localStorage.setItem('lastFormationTeam', e.target.value);
          ...
          <FormControl size="small" className="min-w-[120px]">
            ...
            <Select
              ...
              onChange={(e) => {
                ...
                localStorage.setItem('lastFormationId', newFormation);
                ...
                setTeamInfo(prev => ({ ...prev, formation: newFormation }));
      ...
      <div className="flex flex-col lg:flex-row gap-6 mb-6">
        ...
        <div className="lg:w-2/3">
          ...
          <div className="mb-2 text-sm text-gray-400">Drag to swap players</div>

          <div className="op-pitch-container">
      ...
      <div className="flex justify-between items-center mt-6 pt-4 border-t border-gray-700">
        ...
        <ButtonGroup variant="contained">
          ...
          {isVisible ? (
            ...
            <Button color="error" onClick={handleHideOverlay} className="font-bold">
            ...
            <Button color="success" onClick={handleUpdateOverlay} className="font-bold bg-[#D9FF00] text-black hover:bg-[#b8d900]">
          ...
          {isVisible && (
            ...
            <Button color="warning" onClick={handleUpdateOverlay} className="font-bold">
