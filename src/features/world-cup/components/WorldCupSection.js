...
const resolveNationalLogo = (team) => {
  ...
  const countryMap = {
    ...
    belgium: "be", uruguay: "uy", croatia: "hr", senegal: "sn", usa: "us",
    mexico: "mx", canada: "ca", morocco: "ma", japan: "jp", "south korea": "kr",
    australia: "au", saudi_arabia: "sa", switzerland: "ch", denmark: "dk",
    poland: "pl", ukraine: "ua", sweden: "se", wales: "gb-wls",
    ecuador: "ec", qatar: "qa", iran: "ir", ghana: "gh", cameroon: "cm",
    tunisia: "tn", serbia: "rs", costa_rica: "cr", canada: "ca"
  };
...
export function WorldCupMain({
  ...
  return (
    <div className="w-full">
      ...
      <div style={{ background: 'var(--mui-palette-background-paper)' }} className="border border-slate-700/10 rounded-2xl p-4 mb-6 max-w-[1040px] mx-auto w-full flex flex-wrap justify-between items-center gap-4 shadow-sm">
        ...
        <div className="flex items-center gap-6 text-xs font-semibold text-textSecondary">
          <div>
            <span className="text-textSecondary/60 uppercase tracking-wider text-[10px] block font-semibold">Country</span>
          ...
          <div>
            ...
            <span className="text-purple-600 bg-purple-500/10 border border-purple-500/20 px-2.5 py-0.5 rounded-full text-[10px] font-bold font-mono">CUP</span>
          </div>
        </div>
      </div>
    ...
    <div className={`${cardClass} rounded-xl p-5 space-y-5 w-full max-w-[1040px] mx-auto`}>
      ...
      {loadingStandings ? (
        <p className="text-center text-gray-400 text-sm py-4">
          Loading World Cup Standings...
        </p>
      ) : !groups.length ? (
        <p className="text-center text-gray-400 text-sm py-4">
          World Cup standings are not available at this moment.
        </p>
      ) : (
...
return (
                        ...
                        <td className={`${cellCenter} font-bold text-emerald-400`}>
                          {row.points}
                        </td>
                      </tr>
                    ))}
      ...
      {loadingMatches ? (
        <div className={`${cardClass} rounded-xl p-8`}>
          <p className="text-center text-gray-400 text-sm">
            Loading World Cup Match Schedules...
          </p>
        </div>
