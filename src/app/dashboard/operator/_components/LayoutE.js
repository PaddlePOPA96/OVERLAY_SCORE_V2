...
export default function LayoutE({ data, displayTime, formatTime }) {
  ...
  const teamLeftColor = isSwapped ? (data.awayColor || data.awayBg || "#ff4655") : (data.homeColor || data.homeBg || "#00f5a0");
  ...
  const teamRightColor = isSwapped ? (data.homeColor || data.homeBg || "#00f5a0") : (data.awayColor || data.awayBg || "#ff4655");
      ...
      <div className={`layout-e-container ${isHiding ? "layout-e-hide" : ""}`}>
        ...
        <div className="flex items-stretch justify-between w-[591px]">
          ...
          <div className="flex items-center justify-end mr-[3px]">
            ...
            >
              ...
              <div className="flex flex-col justify-center leading-none text-left flex-1">
                ...
                <span className="text-[10px] text-gray-300 font-bold mt-1 font-sans uppercase tracking-wider">{teamLeftFullName}</span>
              </div>
            </div>
            ...
            {/* 2. Kotak Skor Kiri */}
            <div
              className={`text-white flex items-center justify-center font-bold text-[26px] font-mono transition-all duration-300 ${showGoal && goalTeam === teamLeftName ? "goal-flash-glow" : ""
                }`}
              style={{
                width: '60px',
                height: '48px',
          ...
          <div className="w-[150px] h-[48px] flex items-center justify-center relative overflow-visible">
            {showGoal ? (
              ...
              >
                <span className="uppercase font-sans text-center">
                  {goalTeam ? `${goalTeam} WIN` : "ROUND WIN"}
                </span>
              </div>
            ) : null}
          </div>
          ...
          <div className="flex items-center justify-start ml-[3px]">
            ...
            {/* 1. Kotak Skor Kanan */}
            <div
              className={`text-white flex items-center justify-center font-bold text-[26px] font-mono transition-all duration-300 ${showGoal && goalTeam === teamRightName ? "goal-flash-glow" : ""
                }`}
              style={{
                width: '60px',
                height: '48px',
            ...
            >
              ...
              <div className="flex flex-col justify-center leading-none text-right flex-1">
                ...
                <span className="text-[10px] text-gray-300 font-bold mt-1 font-sans uppercase tracking-wider">{teamRightFullName}</span>
              </div>
        ...
        <div className="w-[591px] flex justify-between items-start mt-1.5">
          ...
          <div
            ...
            style={{ width: '217.5px', paddingLeft: '157.5px' }}
          >
          ...
          <div
            className="flex justify-center gap-2 pt-1"
            style={{ width: '217.5px', paddingRight: '157.5px' }}
          >
            {Array.from({ length: maxDiamonds }).map((_, i) => {
