      ...
      <div className={wrapperClass}>
        <div className='layout-b-scoreboard' style={boardStyle}>
          ...
          <div className='layout-b-score-panel'>
            <div className='layout-b-score-row layout-b-home-row' style={{ color: homeTextColor }}>
              <span>{data.homeScore}</span>
            </div>
            <div className='layout-b-score-row layout-b-away-row' style={{ color: awayTextColor }}>
