...
export default function LayoutAFF2({ data, displayTime, formatTime }) {
  ...
  return (
    <div
      className="flex items-center justify-center p-4 pt-[60px] relative w-full"
      style={{ transform: transformScale, transformOrigin: 'top center', fontFamily: "'Poppins', sans-serif" }}
    >
      <div
      ...
      >
        ...
        >
          <path d="M135 49H440L409.674 175.657C407.519 184.655 399.475 191 390.223 191H186.116C176.938 191 168.939 184.754 166.713 175.851L135 49Z" fill="#23A5CF" />
          <path d="M0 49H122L135.5 115H24L0 49Z" fill="#062258" />
          <path d="M575.5 49H453.5L440 115H551.241L575.5 49Z" fill="#042358" />
          <path d="M24 115H157.5V124H27L24 115Z" fill="#23A5CF" />
          <path d="M551 115H424L422 124H548L551 115Z" fill="#23A5CF" />
        </svg>
        ...
        <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', zIndex: 2 }}>
          ...
          >
            {data.useCustomFifaLogo ? (
              ...
              <div key="logo-aff2-b2f" className="logo-anim-in" style={{ width: '90px', height: '90px', backgroundColor: '#FFE600', borderRadius: '100%' }}>
