    ...
    return (
        ...
        >
            ...
            {playError && (
                ...
                >
                    <div style={{ backgroundColor: '#ef4444', color: 'white', padding: '15px 30px', borderRadius: '30px', fontWeight: 'bold', fontFamily: '"Poppins", sans-serif', fontSize: '20px', boxShadow: '0 4px 10px rgba(0,0,0,0.5)', textAlign: 'center' }}>
